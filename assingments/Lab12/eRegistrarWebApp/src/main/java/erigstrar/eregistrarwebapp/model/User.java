...
@Entity
@Table(name = "users")
// @NamedNativeQuery(name="findRolesByUserId", query = "select r.role_id,
// r.name\n" +
// "from users_roles ur \n" +
// "inner join roles r on r.role_id = ur.role_id\n" +
// "where ur.user_id = 3")
public class User implements UserDetails {
    // DONE: Declare class User implements
    // org.springframework.security.core.userdetails.UserDetails
    // This has enabled integrating my custom user data fields - firstName, lastName
    // etc.
